...
const AboutCatMoney = () => {
  return (
    <div className="max-w-[1320px] w-full mx-auto px-5 mt-14 sm:mt-20 lg:mt-[112px] flex items-center justify-between max-md:flex-col">
      <div className="max-w-[630px] w-full">
        ...
        <p className="text-white font-barlow text-base lg:text-lg font-normal leading-[150%] mt-5">
        ...
        <p className="text-white font-barlow text-base lg:text-lg font-normal leading-[150%] mt-4">
        ...
        <p className="text-white font-barlow text-base lg:text-lg font-normal leading-[150%] mt-6">
          his grand monthly event offers participants the chance to win massive
          rewards.
        </p>
      </div>
